...
void Experiment::findChains(int a, int b)
{
...
void Experiment::recursiveFindChains(string effect, int src, int dest, vector<bool> &visited, vector<pair<int, string>> &path)
{
    visited[src] = true;
...
void Experiment::printChain(vector<pair<int, string>> &path)
{
    // cout << "\nChain: \n";
    for (auto i : path)
    {
